    ...
    function owlcarousel() {
        jQuery('.owl-carousel').each(function() {
            ...
            jQuerycarousel.owlCarousel({
                ...
                responsive: {
                    0: {
                        items: jQuerycarousel.data('xs-items') ? jQuerycarousel.data('xs-items') : 1
                    },
                    576: {
                        items: jQuerycarousel.data('sm-items')
                    },
                    768: {
                        items: jQuerycarousel.data('md-items')
                    },
                    1024: {
                        items: jQuerycarousel.data('lg-items')
                    },
                    1200: {
                        items: jQuerycarousel.data("items")
                    }
